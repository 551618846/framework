...
$.extend($.validator, {
	...
	prototype: {
		...
		element: function( element ) {
			element = this.validateTargetFor( this.clean( element ) );
		...
		showErrors: function( errors ) {
			...
			if ( this.settings.showErrors ) {
				this.settings.showErrors.call(this.errorMap, this.errorList ,this.settings);
			} else {
		...
		defaultShowErrors: function() {
			...
			for ( i = 0; this.errorList[i]; i++ ) {
				...
				if (this.settings.showLabel) {
				    this.settings.showLabel(error.element, error.message,this.settings);
				} else {
		...
		validateTargetFor: function( element ) {
	...
	metadataRules: function (element) {
	    ...
	    var meta = validator.settings.meta;
