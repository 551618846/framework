...
(function ($) {
    ...
    function _282(_283) {
        ...
        function _288(pp) {
            ...
            cpos.left += pp.panel("options").width==38?42:pp.panel("options").width;
            cpos.width -= pp.panel("options").width;
    ...
    function _295(_296, _297) {
        ...
        if (_297 == "east") {
            ...
            if (_297 == "west") {
                ...
                _298.center.panel("resize", { width: _298.center.panel("options").width + _298.west.panel("options").width - 42, left: 42 });
                _298.west.panel("panel").animate({ left: -_298.west.panel("options").width }, function () {
                    _298.west.panel("close");
                    _298.expandWest.panel("open").panel("resize", { top: _298.west.panel("options").top, left: 0, width: 38, height: _298.west.panel("options").height });
                ...
                if (_297 == "north") {
                    ...
                    _298.center.panel("resize", { top: 30, height: hh });
                    _298.east.panel("resize", { top: 30, height: hh });
                    _298.west.panel("resize", { top: 30, height: hh });
                    if (_289(_298.expandEast)) {
                        _298.expandEast.panel("resize", { top: 30, height: hh });
                    }
                    if (_289(_298.expandWest)) {
                        _298.expandWest.panel("resize", { top: 30, height: hh });
                    }
                    _298.north.panel("panel").animate({ top: -_298.north.panel("options").height }, function () {
                        _298.north.panel("close");
                        _298.expandNorth.panel("open").panel("resize", { top: 0, left: 0, width: cc.width(), height: 30 });
